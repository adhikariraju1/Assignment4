...
## Inferential statistics {.flexbox .vcenter}

```{r regression1, results='asis'}
stargazer(m1, m2, type='html', covariate.labels = labels, 
          title = 'Effect of Income Inequality on EPI', font.size = 'scriptsize')
```

## Inferential statistics(contd.) {.flexbox .vcenter}

```{r regression2, results='asis'}
stargazer(m3, m4, m5, type='html', covariate.labels = labels, 
          title = 'Effect of Income Inequality on EPI', font.size = 'scriptsize')
```
